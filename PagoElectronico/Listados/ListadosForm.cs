...
namespace PagoElectronico.Listados
{
    public partial class ListadosForm : Form
    {
        ...
        private void loadListado(){
            ...
            this.Listado.Add("Top 5 Países con mayor cantidad de movimientos tanto ingresos como egresos.", "SELECT TOP 5 pa.Pais_Desc, [GD1C2015].[NULL].fnCantidadMovimientos(pa.Pais_Codigo, @year, @mesi, @mesf) total FROM [GD1C2015].[NULL].[Pais] AS pa ORDER BY total DESC");
